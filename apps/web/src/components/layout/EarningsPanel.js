...
function EarningsPanel() {
    ...
    return (<ModalOverlay_1.default onClose={function () { return setOpen(false); }} ariaLabelledBy="earnings-panel-title">
      <div className={EarningsPanel_module_css_1.default.panel}>
        ...
        <div className={EarningsPanel_module_css_1.default.panelHeader}>
          {isConnected ? (<div className={EarningsPanel_module_css_1.default.avatarWrap}>
              ...
              <div>
                <div id="earnings-panel-title" className={EarningsPanel_module_css_1.default.addressText}>
                  {shortAddress}
                </div>
                <div className={EarningsPanel_module_css_1.default.chainText}>HyperEVM</div>
              </div>
            </div>) : (<div id="earnings-panel-title" className={EarningsPanel_module_css_1.default.profileLabel}>
              profile
            </div>)}
