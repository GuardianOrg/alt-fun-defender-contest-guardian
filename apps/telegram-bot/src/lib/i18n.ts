...
export const HELP_SECURITY_HTML = {
  English: [
    ...
    "",
    "<b>Withdrawal lock</b>",
    "Enable the withdrawal lock in /wallet to block all outbound transfers. Enabling is instant. Disabling is two-phase: tap [Disable], wait 24 hours, then tap [Complete disable] on /wallet to actually clear it. A pending disable shows a [Cancel disable] button so you can revoke it before it takes effect.",
    "",
  ...
  SimplifiedChinese: [
    ...
    "",
    "<b>提币锁</b>",
    "在 /wallet 中启用提币锁，可阻止所有外部转账。启用立即生效。停用分两步：先点击 [停用]，等待 24 小时，再在 /wallet 中点击 [完成停用] 才会真正解除。冷却期内会显示 [取消停用] 按钮，可在生效前撤销。",
    "",
    "<b>若怀疑账户已被入侵</b>",
    "• 立即启用提币锁，冻结所有外部转账。",
...
export const HELP_WITHDRAW_HTML = {
  English: [
    ...
    "2. If the withdrawal lock is enabled in /wallet, the withdrawal is blocked — disable the lock in /wallet first (24-hour cooldown applies)",
    "3. PIN prompt",
  ...
  SimplifiedChinese: [
    ...
    "2. 若在 /wallet 中启用了提币锁，则提币被阻止——请先在 /wallet 中停用提币锁（适用 24 小时冷却期）",
    "3. PIN 码验证",
