...
function useCreateToken() {
    ...
    var _d = (0, react_1.useState)(null), warning = _d[0], setWarning = _d[1];
    var _e = (0, react_1.useState)(null), tokenAddress = _e[0], setTokenAddress = _e[1];
    var create = (0, react_1.useCallback)(function (params) { return __awaiter(_this, void 0, void 0, function () {
        var lts, isLong, lt, usdcAmount, allowance, approveTx, socials, launchParams, seedUsdcAmount, tx, receipt, tokenCreatedEvents, newTokenAddr, warnings, imageUrl, uploaded, _a, ltDir, normalizedToken, normalizedCreator, apiPayload, message, signature, _b, e_1;
    ...
    return { step: step, error: error, warning: warning, tokenAddress: tokenAddress, create: create, reset: reset };
}
