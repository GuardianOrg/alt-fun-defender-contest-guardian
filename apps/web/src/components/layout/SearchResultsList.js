...
function SearchResultsList(_a) {
    ...
    return (<div className={SearchModal_module_css_1.default.resultsWrap} ref={listRef}>
      {results.length > 0 ? (results.map(function (t, i) {
            ...
            return (<div key={t.address} data-result-index={i} className={(0, format_1.cn)(SearchModal_module_css_1.default.resultRow, i === highlightedIndex && SearchModal_module_css_1.default.resultRowHighlighted)} role="button" tabIndex={0} onClick={function () { return onSelect(t.address); }} onKeyDown={handleKeyDown} onMouseEnter={function () { return onHighlight(i); }}>
        ...
        })) : (<div className={SearchModal_module_css_1.default.noResults}>No tokens found</div>)}
    </div>);
}
