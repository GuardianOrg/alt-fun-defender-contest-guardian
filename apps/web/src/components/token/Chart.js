...
function fetchChartData(address, interval) {
    return __awaiter(this, void 0, void 0, function () {
        var res, json, candles, _a;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("".concat(API_BASE, "/api/v1/trades/ohlcv/").concat(address, "?interval=").concat(interval))];
                case 1:
                    res = _c.sent();
                    return [4 /*yield*/, res.json()];
                case 2:
                    json = _c.sent();
                    candles = (_b = json.data) !== null && _b !== void 0 ? _b : [];
                    if (candles.length === 0)
                        return [2 /*return*/, []];
