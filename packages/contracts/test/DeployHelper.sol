...
abstract contract DeployHelper is Test {
    ...
    /// @notice Deploys all core contracts and wires roles. Does NOT set the redemption router
    /// on Bonding — callers must do that themselves (e.g. `bonding.setRedemptionRouter(...)`).
