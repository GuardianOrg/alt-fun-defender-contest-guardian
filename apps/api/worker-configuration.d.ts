/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 01f57eeef548c118707a1582985214c0)
// Runtime types generated with workerd@1.20260420.1 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WebSocketDO" | "LtTicker" | "WsIpLimiter" | "LtDirectoryPoller";
	}
	interface Env {
		...
		HELIO_API_SECRET: string;
		HELIO_DEPOSIT_ID: string;
		HELIO_API_BASE_URL: string;
		...
		LT_DIRECTORY_POLLER_DO: DurableObjectNamespace<import("./src/index").LtDirectoryPoller>;
	}
}
