...
var TradePanelBufferWarning_1 = require("./TradePanelBufferWarning");
var TradePanelFooter_1 = require("./TradePanelFooter");
var TradePanelInput_1 = require("./TradePanelInput");
var TradePanelQuote_1 = require("./TradePanelQuote");
...
function TradePanel(_a) {
    var _this = this;
    var token = _a.token;
    var _b = (0, react_1.useState)("buy"), mode = _b[0], setMode = _b[1];
    var _c = (0, react_1.useState)(""), amount = _c[0], setAmount = _c[1];
    var _d = (0, react_1.useState)(0.02), slippage = _d[0], setSlippage = _d[1];
    var _e = (0, react_1.useState)(false), settingsOpen = _e[0], setSettingsOpen = _e[1];
    var _f = (0, react_1.useState)(null), buyQuote = _f[0], setBuyQuote = _f[1];
    var _g = (0, react_1.useState)(null), sellQuote = _g[0], setSellQuote = _g[1];
    var _h = (0, react_1.useState)(null), maxBalance = _h[0], setMaxBalance = _h[1];
    var address = (0, wagmi_1.useAccount)().address;
    var publicClient = (0, wagmi_1.usePublicClient)();
    var _j = (0, useWallet_1.useWallet)(), isConnected = _j.isConnected, connect = _j.connect;
    var referrer = (0, useReferral_1.useReferral)();
    var _k = (0, useTradeRouter_1.useTradeRouter)(), step = _k.step, txHash = _k.txHash, error = _k.error, executeBuy = _k.executeBuy, executeSell = _k.executeSell, reset = _k.reset;
    ...
    return (<div className={TradePanel_module_css_1.default.panel}>
      ...
      <div className={TradePanel_module_css_1.default.formBody}>
        <TradePanelInput_1.default mode={mode} amount={amount} setAmount={setAmount} isBusy={isBusy} maxBalance={maxBalance} sellQuote={sellQuote} token={token}/>

        {amtNum > 0 && (<TradePanelQuote_1.default mode={mode} ticker={ticker} buyQuote={buyQuote} sellQuote={sellQuote}/>)}

        {sellExceedsBuffer && sellQuote && (<TradePanelBufferWarning_1.default sellQuote={sellQuote} ticker={ticker}/>)}
      ...
      <TradePanelFooter_1.default token={token}/>
    </div>);
}
