...
exports.getLtExchangeRates = getLtExchangeRates;
exports.resolveExchangeRate = resolveExchangeRate;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("".concat(shared_1.BOUNCE_INDEXING_API, "/leveraged-tokens"))];
                case 1:
                    res = _a.sent();
