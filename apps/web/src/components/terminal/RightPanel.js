      ...
      <div className={RightPanel_module_css_1.default.section}>
        ...
        <div aria-live="polite" aria-label="Recent trades">
          {trades.map(function (t) {
            ...
            return (<div key={t.id} className={RightPanel_module_css_1.default.tradeRow} tabIndex={0} aria-label={"".concat(isBuy ? "Buy" : "Sell", " ").concat(t.tokenName, " \u2014 $").concat(t.amountUsd.toLocaleString(), " \u2014 ").concat(t.timestamp)}>
