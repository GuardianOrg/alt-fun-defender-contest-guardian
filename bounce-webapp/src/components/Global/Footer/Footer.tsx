...
import { replayPrimerModal } from "../../../state/mintSlice";
...
const Footer = () => {
  ...
  const isMintPage = pathname === "/mint" || pathname.startsWith("/mint/");
  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.footerContent}>
        ...
        {isMintPage && (
          <div className={styles.footerSection}>
            <div className={styles.header}>Guide</div>
            <button
              type="button"
              className={styles.replayPrimerButton}
              onClick={() => dispatch(replayPrimerModal())}
            >
              Replay primer
            </button>
          </div>
