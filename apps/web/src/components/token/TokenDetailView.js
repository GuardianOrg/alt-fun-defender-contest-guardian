...
function TokenDetailView() {
    ...
    return (<div className={TokenDetailView_module_css_1.default.wrapper}>
      <div className={TokenDetailView_module_css_1.default.leftPanel}>
        ...
        <ErrorBoundary_1.default fallback={<div className={TokenDetailView_module_css_1.default.errorFallback}>Chart failed to load</div>}>
        ...
        <ErrorBoundary_1.default fallback={<div className={TokenDetailView_module_css_1.default.errorFallback}>
      ...
      <ErrorBoundary_1.default fallback={<div className={TokenDetailView_module_css_1.default.errorFallback}>Trade panel failed to load</div>}>
