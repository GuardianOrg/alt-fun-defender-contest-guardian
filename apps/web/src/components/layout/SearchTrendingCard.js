...
function SearchTrendingCard(_a) {
    ...
    return (<div ref={cardRef} className={(0, format_1.cn)(SearchModal_module_css_1.default.trendingCard, highlighted && SearchModal_module_css_1.default.trendingCardHighlighted)} onClick={onClick} onMouseEnter={onMouseEnter}>
