...
var router = (0, react_router_1.createBrowserRouter)([
    {
        ...
        element: <Layout />,
        children: [
            { index: true, element: <TerminalView_1.default /> },
            { path: routes_1.TOKEN_ROUTE, element: <TokenDetailView_1.default /> },
            { path: routes_1.CREATE_ROUTE, element: <CreateView_1.default /> },
        ],
    },
]);
