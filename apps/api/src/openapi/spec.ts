...
const tokenSchema = {
  ...
  properties: {
    ...
    telegramUrl: { type: "string", description: "Telegram path component (`<username>`, `+<invite>`, or `joinchat/<hash>`). Frontend builds the link as `https://t.me/<value>`. Empty string when unset or invalid." },
    websiteUrl: { type: "string", description: "Canonical http(s) URL with multi-label ASCII hostname (no userinfo). Empty string when unset or invalid." },
    creator: { type: "string" },
