    ...
    <div className={styles.tokenStatsWrapper}>
      <div className={styles.tokenStats}>
        ...
        <div className={styles.stat}>
          ...
          >
            {signPrefix(selectedTokenStats?.change24h) +
              formatNumber(selectedTokenStats?.change24h) +
              " / " +
              signPrefix(selectedTokenStats?.change24hPct) +
        ...
        <div className={styles.stat}>
          <p>Open Interest</p>
          <span>{formatNumber(selectedTokenStats?.openInterest, false, true)}</span>
        </div>
      </div>
    </div>
  );
