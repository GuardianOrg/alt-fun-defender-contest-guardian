...
function TokenRow(_a) {
    ...
    var handleNavigate = function () { return navigate((0, routes_1.tokenPath)(token.address)); };
    ...
    return (<div className={(0, format_1.cn)(TokenRow_module_css_1.default.row, isGraduating
            ...
            : (0, format_1.cn)(TokenRow_module_css_1.default.normalRow, isShort
                ...
                : isLtMover
                    ? TokenRow_module_css_1.default.borderAmber
                    : TokenRow_module_css_1.default.borderMint))} role="link" tabIndex={0} onClick={handleNavigate} onKeyDown={handleKeyDown} aria-label={"".concat(token.name, " \u2014 ").concat((0, format_1.formatPercent)(token.change24h), " \u2014 market cap ").concat((0, format_1.formatUsd)(token.mcapUsd))}>
      {/* Icon */}
